...
import { getAllPlayers, getDataPlayer, getEvaluations, getHelps, getHistory, getMessages, getPDF } from './API.js';
...
const socket = io('http://site181997.tw.cs.unibo.it', {query: 'type=evaluator'});
...
function TabPanel(props) {
    ...
    return (
        e("div", { key: index, role: "tabpanel", hidden: value !== index, id: `scrollable-force-tabpanel-${index}`, "aria-labelledby": `scrollable-force-tab-${index}`, ...other }, [
            (value === index) && e(Box, { p: 3 }, [
                e("div", {key: "div_" + index}, [children])
            ])
        ])
    );
}
...
export default function Control(props){
    ...
    return e(React.Fragment, null, [ 
        e("div", { className: classes.root }, [
            e(AppBar, { key:"AppBar", style: {border: "none", backgroundColor: "primary"}, position: "static", children: [
                e(Tabs, { key: "Tabs", className: classes2.tab, style: {width: "auto"}, scrollButtons: "on", centered: screen.width > 800 ? true : false, variant: screen.width <= 800 ? "scrollable" : "standard", value: value, onChange: handleChange, children: [
                    e(Tab, { key: "Tab1", label: "Giocatori" , ...a11yProps(0) }),
                    e(Tab, { key: "Tab2", label: "Classifica", ...a11yProps(1) }),
                    e(Tab, { key: "Tab3", label: "Aiuti", ...a11yProps(2) }),
                    e(Tab, { key: "Tab4", label: "Valutazioni", ...a11yProps(3) }),
                    e(Tab, { key: "Tab5", label: "Info", ...a11yProps(4) }),                
                ] })
            ] }),
            e(TabPanel, { key: "TabP1", value: value, index: 0, children: [
                e(Box,{key: "arrayPlayers"}, arrayPlayers)
            ] }),
            e(TabPanel, { key: "TabP2", value: value, index: 1, children: [
                e(BasicTable, {story: story})
            ] }),
            e(TabPanel, { key: "TabP3", value: value, index: 2, children: [
            ...
            e(TabPanel, { key: "TabP4", value: value, index: 3, children: [
            ...
            e(TabPanel, { key: "TabP5", value: value, index: 4, children: [
                ...
                e(TableContainer, {key: "TableContainer", style: {marginBottom: 15}, component: Paper, children: [
                    e(Table, {key: "Table", className: classes2.table, children: [
                        e(TableHead, {key: "Thead", children: [
                            e(TableRow, {key: "Trow", children: [
                                e(TableCell, {key: "TabC1", align: "center", children: "Section"}),
                                e(TableCell, {key: "TabC2", align: "center", children: "Question"}),
                                e(TableCell, {key: "TabC3", align: "center", children: "Answer"}),
                                e(TableCell, {key: "TabC4", align: "center", children: "Time"}),
                                e(TableCell, {key: "TabC5", align: "center", children: "Points"})
                            ]}),
                        ]}),
                        e(TableBody, {key: "Tbody", children: [
                            (rows.map((row) => (
                                e(TableRow, { key: row.name, children: [
                                    e(TableCell, {key: "TabC1", align: "center", component: "th", scope: "row", children: row.section}),
                                    e(TableCell, {key: "TabC2", align: "center", component: "th", scope: "row", children: row.question}),
                                    e(TableCell, {key: "TabC3", align: "center", component: "th", scope: "row", children: row.answer}),
                                    e(TableCell, {key: "TabC4", align: "center", component: "th", scope: "row", children: row.time}),
                                    e(TableCell, {key: "TabC5", align: "center", component: "th", scope: "row", children: row.points}),
                                ]})
                            )))]})
                    ]})
                ]}),
                ID !== "" && e(Button, {key: "Button_Download", size: "large", variant: "contained", onClick: async() => { await getPDF(ID, story)}}, "Download" ),
            ] })
        ])
    ]);
}
