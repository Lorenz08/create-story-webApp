...
function Realize_FL_Activity(props){
    ...
    async function createActivity(){
        ...
        if (imageBackground != null){
            await axios.post(`http://site181997.tw.cs.unibo.it/addImage/${props.story.id}/${props.indexActivity}_background`, imageBackground, {
        ...
        if (imageActivity != null){
            await axios.post(`http://site181997.tw.cs.unibo.it/addImage/${props.story.id}/${props.indexActivity}_activity`, imageActivity, {
                headers:{ "Content-Type": "multipart/form-data" }
            })
            .then((response) => {
