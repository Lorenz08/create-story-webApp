...
function SelectHome(){
    ...
    function generateQRCode() {
        if (storySelected == ""){
            ...
            qr = new QRious({
                ...
                size: 200,
                value: `http://site181997.tw.cs.unibo.it/src2/index2.html?story=${story}`
            });
            setLink(`http://site181997.tw.cs.unibo.it/src2/index2.html?story=${story}`)
        }
    }
    ...
    React.useEffect(() => {
        axios.get(`http://site181997.tw.cs.unibo.it/storiesFolder`)
        .then((response) => {
