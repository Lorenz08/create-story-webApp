...
export function getID(playerID, story, question){
    ...
    axios.post(`http://site181997.tw.cs.unibo.it/updateData`, {id: playerID, name: "", sectionArray: player, story : story});
}
...
export function sendData(playerID, question, answer, section, timer, story, points){
    ...
    axios.post(`http://site181997.tw.cs.unibo.it/updateData`, {id: playerID, sectionArray: player, story : story});
}
export function postOnServer(playerID, story){
    axios.post('http://site181997.tw.cs.unibo.it/postJson', {id : playerID, story : story})
}
